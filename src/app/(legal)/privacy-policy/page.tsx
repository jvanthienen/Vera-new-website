...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy for Vera - Your Human Design Guide",
};
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-20">
      <div className="prose prose-gray dark:prose-invert max-w-none">
        <h1 className="font-serif text-4xl font-bold tracking-tight sm:text-5xl mb-8">PRIVACY POLICY</h1>
        ...
        <p><strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by contacting us at support@hellovera.app.</p>
        ...
        <p><strong>Payment Data.</strong> We may collect data necessary to process your payment if you choose to make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is handled and stored by RevenueCat and Apple. You may find their privacy notice links here: <a href="https://www.revenuecat.com/privacy/" className="text-blue-600 hover:underline">RevenueCat Privacy</a> and <a href="https://www.apple.com/legal/privacy/" className="text-blue-600 hover:underline">Apple Privacy</a>.</p>
        
        <h2 className="text-2xl font-bold mt-8 mb-4">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
        
        <p>If you have questions or comments about this notice, you may email us at support@hellovera.app or contact us by post at:</p>
        
        <address className="not-italic mt-4">
          Kasegu LLC<br />
          2109 N St, Sacramento, CA 95816, USA<br />
          Sacramento, CA 95816<br />
          United States
        </address>
        
        <h2 className="text-2xl font-bold mt-8 mb-4">HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
        
        <p>Based on the applicable laws of your country or state of residence in the US, you may have the right to request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information. You may also have the right to withdraw your consent to our processing of your personal information. These rights may be limited in some circumstances by applicable law. To request to review, update, or delete your personal information, please contact us at support@hellovera.app.</p>
      </div>
    </div>
  );
}
